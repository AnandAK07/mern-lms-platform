...
import { aboutUsStyles, aboutUsAnimations } from "../assets/styles/dummyStyles";
import {
  counterTargets,
  statsMeta,
  missionVisionValues,
  ...
  values,
  testimonials,
} from "../data/dummyAbout";
import AboutBanner from "../assets/images/AboutBannerImage.png";
              ...
              >
                ...
                <div className={aboutUsStyles.featuresContainer}>
                  {section.features.map((feature, index) => (
                    <div key={index} className={aboutUsStyles.featureItem}>
                      <div
        ...
        <div className={aboutUsStyles.sectionGrid}>
          ...
          <div className={aboutUsStyles.teamGrid}>
            {teamMembers.map((member, index) => (
              <div className={aboutUsStyles.teamMember} key={index}>
      ...
      <section className={aboutUsStyles.ctaSection}>
        ...
        <div className={aboutUsStyles.ctaContent}>
          ...
          <p className={aboutUsStyles.ctaDescription}>
            ...
            LearnHub. Start your journey today with a 7-day free trai l.
          </p>
