...
import { navbarStyles } from "../assets/styles/dummyStyles";
...
export const Navbar = () => {
  ...
  const desktopLinkClass = (isActive) => {
    return `${navbarStyles.desktopNavItem} ${isActive ? navbarStyles.desktopNavItemActive : ""}`;
  };

  const mobileLinkClass = (isActive) => {
    return `${navbarStyles.mobileMenuItem} ${isActive ? navbarStyles.mobileMenuItemActive : navbarStyles.mobileMenuItemHover}`;
  };
  return (
    <nav
      className={`${navbarStyles.navbar}  ${showNavbar ? navbarStyles.navbarVisible : navbarStyles.navbarHidden} ${isScroll ? navbarStyles.navbarScrolled : navbarStyles.navbarDefault}`}
    >
