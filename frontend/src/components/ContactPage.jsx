...
import { contactStyles } from "../assets/styles/dummyStyles";
...
export const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappUrl = `https://wa.me/918123483698?text=${whatsappMessage}`;
            ...
            <div className={contactStyles.formContainer}>
              ...
              <div className={contactStyles.form}>
                ...
                >
                  ...
                  {/* message */}
                  <div className={contactStyles.nameformGroup}>
                    <label className={contactStyles.label}>
                      <MessageCircleDashed
                        className={`${contactStyles.labelIcon} ${contactStyles.colors.blue.icon}`}
                      />
        ...
        <div className={contactStyles.footer}>
          <div className={contactStyles.footerBadge}>
            ...
            <span className={contactStyles.footerText}>
              All messages are send to Whatsapp for immediate response
            </span>
          </div>
        </div>
      </div>
