...
import { courseDetailStyles } from "../assets/styles/dummyStyles";
...
export const CourseDetails = () => {
  ...
  return (
    <div className={courseDetailStyles.container}>
      ...
      <div
        className={`${courseDetailStyles.mainContainer} ${isPageLoaded ? courseDetailStyles.containerVisible : courseDetailStyles.containerHidden}`}
      >
        ...
        >
          ...
          <div
            className={`${courseDetailStyles.teacherStat} ${isTeacherAnimating ? courseDetailStyles.animations : ""}`}
          >
